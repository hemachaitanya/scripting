* shell scripting is automation of repetative tasks
...
30-Aug-23
---------
## What is the difference between statically typed(Strongly typed) and Dynamically typed (loosly typed) language?
...
*  Now this .java file we submit to java compiler (javac) for compilation process.
